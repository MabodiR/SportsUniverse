...
<template>
    ...
    <AppShell>
        <main class="saved-page">
            ...
            <section v-if="!loading&&!(tab==='profiles'?filteredProfiles.length:filteredVideos.length)" class="saved-empty"><Bookmark/><h2>{{query?'No matching saved items':`No saved ${tab} yet`}}</h2><p>Save {{tab}} while exploring SportUniverse and they will appear here.</p><Link href="/explore">Explore talent</Link></section>
        </main>
