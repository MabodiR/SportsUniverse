            ...
            <section class="login-side">
                ...
                <div class="login-card">
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <p class="mobile-register">New to SportsUniverse? <Link href="/register">Create your account</Link></p>
                    </form>
                </div>
...
.login-side{display:flex;min-width:0;flex-direction:column;padding:30px clamp(28px,5vw,70px)}.new-account{align-self:flex-end;margin:0;color:#6c788b;font-size:12px}.new-account a,.login-options a{color:#476FEA;font-weight:800;text-decoration:none}.login-card{width:min(100%,510px);margin:auto;padding:clamp(28px,3vw,44px);border:1px solid #e4e8ef;border-radius:28px;background:#fff;box-shadow:0 20px 55px rgba(35,55,88,.10)}.card-heading>span{color:#476FEA;font-size:10px;font-weight:900;letter-spacing:.13em}.card-heading h2{margin:7px 0 5px;color:#121c2d;font-size:28px;letter-spacing:-.035em}.card-heading p{margin:0 0 24px;color:#748095;font-size:13px;line-height:1.5}.login-card form{display:grid;gap:15px}.login-card form>label{display:grid;gap:7px;color:#172033;font-size:12px;font-weight:800}.login-field{display:flex;height:53px;align-items:center;gap:11px;padding:0 15px;border:1px solid #d8dee8;border-radius:15px;background:#fff;transition:.2s}.login-field:focus-within{border-color:#476FEA;box-shadow:0 0 0 3px rgba(23,101,244,.1)}.login-field>b{color:#66758c;font-size:17px}.login-field>svg{width:18px;color:#7a879e}.login-field input{min-width:0;height:100%;flex:1;color:#172033;border:0;outline:0;background:transparent;font:inherit;font-weight:500}.login-field button{display:grid;width:34px;height:34px;padding:0;place-items:center;color:#7a879e;border:0;border-radius:9px;background:transparent;cursor:pointer}.login-field button:hover{color:#476FEA;background:#eff5ff}.login-field button svg{width:18px}.login-options{display:flex;align-items:center;justify-content:space-between;color:#66758c;font-size:12px}.login-options label{display:flex;align-items:center;gap:7px}.login-options input{accent-color:#476FEA}.login-submit{height:53px;color:#fff;border:0;border-radius:15px;background:#476FEA;box-shadow:0 10px 24px rgba(36,104,242,.22);font-size:14px;font-weight:850;cursor:pointer}.login-submit:hover:not(:disabled){background:#1558df;transform:translateY(-1px)}.login-submit:disabled{cursor:not-allowed;opacity:.5}.login-divider{display:flex;align-items:center;gap:12px;color:#66758c;font-size:11px;text-align:center}.login-divider i{height:1px;flex:1;background:#e2e6ed}.social-actions{display:grid;gap:11px}.social-actions a{display:grid;min-height:49px;place-items:center;color:#182235;border:1px solid #d8dee8;border-radius:15px;background:#fff;font-size:13px;font-weight:800;text-decoration:none}.social-actions a:hover{border-color:#8bb3fb;background:#f8fbff}.social-actions .google-login{border:2px solid #86C0ED}.mobile-register{display:none;margin:3px 0 0;text-align:center;color:#6c788b;font-size:12px}.mobile-register a{color:#476FEA;font-weight:850;text-decoration:none}.field-error{color:#c52c64;font-size:11px;font-weight:600}.social-error{text-align:center}.login-side footer{display:flex;align-items:center;justify-content:space-between;padding-top:20px;color:#8a94a5;font-size:11px}.login-side footer nav{display:flex;gap:15px}.login-side footer a{color:#66758c;text-decoration:none}
@media(max-width:800px){.login-screen{padding:0}.login-shell{min-height:100vh;display:block;border-radius:0}.login-hero{min-height:280px;padding:48px 30px 64px}.hero-copy{margin:38px 0 0}.hero-copy h1{font-size:38px}.login-hero>small{display:none}.login-side{margin-top:-30px;padding:0 20px 28px;position:relative;z-index:2}.new-account{display:none}.mobile-register{display:block}.login-card{padding:60px 22px 20px;border-radius:30px}.card-heading{display:none}.login-side footer{justify-content:center;margin-top:20px}.login-side footer>span{display:none}}
