            ...
            <form v-if="profile" @submit.prevent="save">
                ...
                <div class="edit-sections">
                    ...
                    <section>
                        <h2>Location</h2>
                        <div class="edit-fields">
                            <label class="wide">Find your location<OpenStreetMapPlaceInput :model-value="profileLocation" :country="form.country || 'ZA'" @place="applyLocation"/><small>Select a suggestion to fill the structured fields below.</small></label>
