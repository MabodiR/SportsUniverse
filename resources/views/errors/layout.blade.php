...
<head>
    ...
    <title>{{ $title }} · SportUniverse</title>
...
<main class="error-shell">
    <article class="error-card" role="alert">
        ...
        <section class="error-content">
            ...
            <p class="support">{{ $support }} @if($status >= 500) If this continues, contact <a href="mailto:support@sportsuniverse.co.za">SportUniverse support</a>.@endif</p>
        </section>
    </article>
</main>
</body>
