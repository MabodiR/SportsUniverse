...
class VideoResource extends JsonResource {
    public function toArray(Request $request): array {
        ...
        return [
            ...
            'comments_enabled'=>(bool)$this->comments_enabled,'visibility'=>$this->visibility,'status'=>$this->status,'published_at'=>$this->published_at,
            ...
            'viewer'=>['liked'=>(bool)($this->liked_by_viewer_exists??false),'saved'=>(bool)($this->saved_by_viewer_exists??false),'following_creator'=>(bool)($this->creator_followed_by_viewer_exists??false)],
        ];
    }
}
