...
class OpportunityApplicationController extends Controller
{
    ...
    {
        return OpportunityApplicationResource::collection($request->user()->hasMany(OpportunityApplication::class)->with('opportunity.poster.profile', 'opportunity.poster.organisationProfile', 'opportunity.sport', 'opportunity.position', 'user.profile', 'resume')->latest()->paginate(20));
    }
    ...
    public function applicants(Opportunity $opportunity): AnonymousResourceCollection
    {
        ...
        return OpportunityApplicationResource::collection($opportunity->applications()->with('opportunity.poster.profile', 'opportunity.poster.organisationProfile', 'opportunity.sport', 'opportunity.position', 'user.profile', 'resume')->latest()->paginate(30));
    }
    ...
    {
        return $application->load('opportunity.poster.profile', 'opportunity.poster.organisationProfile', 'opportunity.sport', 'opportunity.position', 'user.profile', 'resume');
    }
}
