...
class ClubPageController extends Controller
{
    public function __invoke(string $slug): Response
    {
        ...
        $title = $club->name.' | SportsUniverse';
        $description = str($club->bio ?: 'View this club, its staff and latest sporting opportunities on SportsUniverse.')->squish()->limit(160)->value();
