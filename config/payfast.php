...
return [
    ...
    'sandbox' => $sandbox,
    'merchant_id' => env('PAYFAST_MERCHANT_ID', $sandbox ? '10004002' : null),
    'merchant_key' => env('PAYFAST_MERCHANT_KEY', $sandbox ? 'q1cd2rdny4a53' : null),
    'passphrase' => env('PAYFAST_PASSPHRASE', $sandbox ? 'payfast' : null),
