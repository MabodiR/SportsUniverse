...
const styles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: colors.navy }, topBar: { height: 56, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: colors.line }, topTitle: { color: colors.white, fontSize: 15, fontWeight: '900' }, topActions: { minWidth: 64, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end', gap: 18 }, content: { padding: spacing.lg, paddingBottom: 32 }, badge: { alignSelf: 'flex-start', paddingHorizontal: 10, paddingVertical: 6, borderRadius: radius.pill, backgroundColor: 'rgba(27,99,243,.15)' }, badgeText: { color: '#79A3FF', fontSize: 10, fontWeight: '900', textTransform: 'uppercase' }, title: { color: colors.white, fontSize: 30, lineHeight: 34, fontWeight: '900', letterSpacing: -1, marginTop: 14 }, poster: { color: '#79A3FF', fontSize: 13, fontWeight: '800', marginTop: 8 },
