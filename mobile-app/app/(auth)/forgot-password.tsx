...
const styles = StyleSheet.create({ safe: { flex: 1, backgroundColor: colors.navy }, page: { flex: 1, padding: spacing.lg }, top: { flexDirection: 'row', alignItems: 'center', gap: 20 }, content: { flex: 1, justifyContent: 'center' }, icon: { width: 62, height: 62, borderRadius: 31, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(71,111,234,.14)' }, title: { color: colors.white, fontSize: 34, lineHeight: 38, fontWeight: '900', letterSpacing: -1.2, marginTop: 18 }, copy: { color: colors.muted, fontSize: 14, lineHeight: 21, marginTop: 10, marginBottom: 22 }, label: { color: '#DCE7F5', fontSize: 12, fontWeight: '800', marginBottom: 7 }, input: { height: 52, paddingHorizontal: 16, borderRadius: radius.md, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.surface, color: colors.white } });
