...
export default function FanPreferencesScreen() {
  ...
  return <SafeAreaView edges={['top']} style={styles.safe}><KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
    ...
    <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      <Text style={styles.eyebrow}>YOUR FAN EXPERIENCE</Text><Text style={styles.title}>Sports and favourites</Text><Text style={styles.copy}>Choose what you love so SportUniverse can prioritise more relevant highlights, athletes and opportunities.</Text>
