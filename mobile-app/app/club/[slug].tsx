...
const styles = StyleSheet.create({
  ...
  section: { paddingHorizontal: spacing.md, marginTop: 28 }, sectionHeading: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 12 }, sectionTitle: { color: colors.white, fontSize: 18, fontWeight: '900' }, body: { color: '#D2DEEB', fontSize: 14, lineHeight: 22 }, rowCard: { minHeight: 76, flexDirection: 'row', alignItems: 'center', gap: 12, padding: 12, marginBottom: 9, borderRadius: radius.md, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.surface }, pressed: { opacity: .75 }, rowIcon: { width: 42, height: 42, borderRadius: 21, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(27,99,243,.13)' }, rowContent: { flex: 1 }, rowTitle: { color: colors.white, fontSize: 14, fontWeight: '900' }, rowMeta: { color: colors.muted, fontSize: 11, marginTop: 4 }, deadline: { color: '#79A3FF', fontSize: 10, fontWeight: '700', marginTop: 4 }, staffImage: { width: 46, height: 46, borderRadius: 23, backgroundColor: colors.navyLight }, staffFallback: { alignItems: 'center', justifyContent: 'center', backgroundColor: colors.blue }, staffInitials: { color: '#fff', fontSize: 13, fontWeight: '900' }, capitalize: { textTransform: 'capitalize' }, empty: { alignItems: 'center', gap: 8, padding: 25, borderRadius: radius.md, borderWidth: 1, borderColor: colors.line, borderStyle: 'dashed' }, emptyText: { color: colors.muted, fontSize: 12, textAlign: 'center' },
});
